...
date: 2015-06-01 20:20:07 +0000
Description: Created a static portfolio site using Zurb Foundation and Animate.css
  along with my own code. This version was eventually replaced with a version that
  allows for easier updates. This was a fun static site to build and one of my first
  sites that uses external libraries.
Tags:
- Website
- Static
Categories:
